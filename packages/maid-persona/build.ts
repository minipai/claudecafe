...
// `@claudecafe/maids` package (a devDependency) — no relative ../maids path.
...
const castDir = dirname(require.resolve('@claudecafe/maids/package.json'))
...
console.log(`vendored ${personas.length} personas from @claudecafe/maids -> vendor/`)
