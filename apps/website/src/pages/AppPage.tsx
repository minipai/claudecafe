...
const DOWNLOAD_URL = 'https://github.com/minipai/claudecafe/releases/download/v0.3.0/ClaudeCafe-0.3.0-arm64.zip'
...
const copy = {
  en: {
    ...
    dlMeta: 'macOS · Apple silicon · v0.3.0 · 317 MB',
    dlNote:
  ...
  zh: {
    ...
    demoHint: '在電腦上看最準。',
    dlMeta: 'macOS · Apple 晶片 · v0.3.0 · 317 MB',
    dlNote:
