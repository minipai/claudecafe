...
const quotes = {
  zh: [
    ...
    { slug: 'kuroko', maid: 'くろこ', line: '旦那様……迷路了嗎？沒關係，くろこ會一直在這裡等的喔。一直……' },
  ...
  en: [
    ...
    { slug: 'kuroko', maid: 'くろこ', line: 'Danna-sama… lost, are you? It\'s okay. Kuroko will be right here, waiting. Always…' },
