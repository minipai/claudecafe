...
export const en = {
  ...
  projects: {
    ...
    oneConversation: '1 conversation',
    conversationCount: '{count} conversations',
    filterFolders: 'Filter folders…',
    search: 'Search conversations…',
    browse: 'Choose a folder…',
    workHere: 'Work in this folder',
    none: 'Nothing has been said in this folder yet.',
  },
  session: {
    title: 'Session',
  },
  ...
  panel: {
    ...
    keys: {
      ...
      settings: 'The settings, and these keys',
