...
export const en = {
  bar: {
    ...
    keys: 'Keys the window answers to',
  ...
  panel: {
    ...
    keys: {
      description: 'What the window answers to without being told.',
      scene: 'On the scene',
      panels: 'Opening things',
      composer: 'While typing to her',
      turn: 'Let her finish the line, or turn to the next one',
      stop: 'Stop what she is doing',
      bar: 'The command bar — folders, conversations, everything else',
      log: 'Everything said so far',
      close: 'Close whatever is open over the scene',
      send: 'Send',
      newline: 'Start a new line instead of sending',
