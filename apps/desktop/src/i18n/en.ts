...
export const en = {
  bar: {
    ...
    step: { folder: 'Folder', conversation: 'Conversation', mode: 'Permission mode', locale: 'Language', speech: 'She speaks' },
  ...
  mode: {
    ...
    note: { default: 'default', auto: 'auto', acceptEdits: 'accept edits', plan: 'plan', bypassPermissions: 'never asks', dontAsk: 'denies instead of asking' },
  },
  ask: {
    allow: 'Allow',
    deny: 'Deny',
