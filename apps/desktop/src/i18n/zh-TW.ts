...
export const zhTW: Text = {
  bar: {
    ...
    step: { folder: '資料夾', conversation: '對話', mode: '權限模式', locale: '語言', speech: '她說的' },
    folder: '去別的地方工作',
    resume: '回到之前的對話',
    newSession: '開一段新對話',
    mode: '權限模式',
  ...
  mode: {
    ...
    note: { default: '預設', auto: '自動', acceptEdits: '直接改檔', plan: '規劃', bypassPermissions: '完全不問', dontAsk: '不問，直接拒絕' },
  },
  ask: {
    allow: '可以',
    deny: '不行',
  ...
  panel: {
    ...
    context: {
      description: '上下文視窗被什麼佔滿了。',
      missing: '這個工作階段回報不出上下文用量。',
      where: '用到哪裡去了',
      memory: '記憶檔案',
      mcpTools: 'MCP 工具',
      onDemand: '用到才載入',
      inUse: '上下文視窗用掉了 {percent}%',
    },
    agents: {
